...
<head>
<title>Log in - Kyle's Wiki</title>
<meta charset="UTF-8" />
...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Bump-serials.sh">
	<h2>Log in</h2>
	<p id="userloginlink"></p>
		<div id="userloginprompt"><p>You must have cookies enabled to log in to Kyle's Wiki.
</p></div>
		<table>
		<tr>
...
<input type="hidden" name="wpLoginToken" value="f7c91fba0515c8432b94c1a97afc1319" /></form>
</div>
<div id="loginend"></div>
</div>				<!-- /bodycontent -->
								<!-- printfooter -->
				<div class="printfooter">
				Retrieved from "<a href="https://wiki.xkyle.com/Special:UserLogin">https://wiki.xkyle.com/Special:UserLogin</a>"				</div>
				<!-- /printfooter -->
												<!-- catlinks -->
...
<div id="p-personal" class="">
	...
	<ul>
		<li id="pt-login" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bump-serials.sh" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
	</ul>
</div>
...
<div id="p-namespaces" class="vectorTabs">
	<h5>Namespaces</h5>
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/index.php?title=Special:UserLogin&amp;returnto=Bump-serials.sh"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
